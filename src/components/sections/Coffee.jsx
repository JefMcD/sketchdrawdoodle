      ...
      <div className="zine-section-wrapper">
          ...
          <section className="zine-section">
            <div className="zine-panel">
              ...
              <p className="writing fs4">
                  If you enjoy using SketchDrawDoodle help us out. Click the Have A Brew link below and for just the price of a cup of coffee you can make a difference.
          ...
          <section className="zine-section alt halftone-bg">
            <div className="zine-panel">
              <h3 className="zine-heading">Have A Brew!</h3>
