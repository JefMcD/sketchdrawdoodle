...
function playerReducer(state, action){
  ...
  switch (action.type) {
    ...
    case ACTIONS.PAN:{
      // Mouse click then drag. This will provide an origin of the mouse when the click was made 
      // then the current value of the x and y coordinates 
...
export default function DoodlePlayerWithZoomFunction({
  ...
  // ====================================================================================
  // MOUSE CLICK AND DRAG IMAGE
  // Mouse click event returns the button clicked and the x and y co-ords of the mouse
  // clientX and clientY
  // ===================================================================================
  ...
  const lastPositionRef = useRef({
    x:0,
    y:0
  }); // The co-ords where the last position was rendered. 
          ...
          */}
          <div className="pic-player-flex-container">
            ...
            > {/* Rotation applies to this container */}
              ...
              </div> {/* grab/move applied to image-position container */}
