...
export default function RewardPopUp({
  ...
  const finishBla = [
    ...
    {label:"Sketch Samurai", message:"Great work! Your lines are getting sharper than the mighty blade of Nabushini!", cta:"🎉 Swoosh!"},
    ...
    {label:"Improving!",     message:"Awesome sketching today — regular practice is the way to drawsomeness", cta:"Hurrah! 🎉"},
    {label:"Phew!",          message:"Practice finished! Time for a brew?", cta:"Burble"},
    //{label:"Inktastic!",     message:"Assessment: You crushed it.", cta:"Boom!"},
    {label:"Congrats",       message:"Nice work! Every practice builds your artist instincts", cta:"🎉 Hmmm.."},
    {label:"ZAP!",           message:"You just fried that drill with intense drawing energy!", cta:"🎉 Crackle!"},
    {label:"Kapow!",         message:"That practice didnt stand a chance", cta:"🎉 RAAWRR!"},
    {label:"BZZT",           message:"Those line were electifiying today.", cta:"🎉 Buzzt!"},
    {label:"OMG!",           message:"That was some seriously impressive sketching", cta:"🎉 Rollin!"},
    {label:"BANG!",          message:"You blasted through that like a stick of dynamite in a jelly factory!", cta:"🎉 SPLAT! 🎉"},
    {label:"POW!",           message:"Another drill knocked out of the ball park!", cta:"🎉 Woosh!"},
    ...
    {label:"Woof!",          message:"Dogged, determined and strong to the finish", cta:"🎉 Rouf! 🎉"},
    {label:"Howl",           message:"That was a wild run at the full moon", cta:"🎉 Grrr! 🎉"},
    ...
    {label:"SLITHER",        message:"Smooth lines, sneaky improvement and super cool", cta:"🎉 Sssssss.. 🎉"},
    ...
    {label:"BzzT",           message:"Your creative energy is buzzing!", cta:"Zapp!"},
    {label:"OMG!",           message:"Stop it, seriously — your art is looking too cute right now!", cta:"💕 (◕‿◕✿) 💕"},
    ...
    {label:"COOL",           message:"Your lines are crisp, your style is chill — frosty vibes activated!", cta:"❄️ ₊˚｡⋆❆⋆｡˚₊ ❄️"},
    ...
    {label:"OINK",           message:"Cute chaos achieved — you doodled like a happy pigles!", cta:"🐷 Snurfle 🐷"},
